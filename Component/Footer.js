    ...
    return (
      ...
      <div className="container-fluid">
        <div className="row mt-5 ml-5 mr-5">
          <div
            className="col-xl-4 col-lg-12 col-md-12 pr-xl-6 mt-5 mb-5 text-lg-center text-md-center"
          >
            <a href="#">
              <img
                src="images/logo.png"
            ...
            <p className="text-6">
              <i
                className="fa fa-envelope ml-4 mt-5 pl-2 pl-md-0"
                aria-hidden="true"
              ></i
              ><span className="pl-3">feedback@pawlife.org</span>
            </p>
            <p className="text-6 mt-3 ml-4 pl-2 pl-md-0">
              Follow Us On<br />
              <a href="#"
          ...
          <div className="col-xl-2 col-lg-3 col-md-3 mt-5 mb-5 mt-lg-7">
