...
export default function Navbar() {
  ...
  useEffect(() => {
    if (
      ...
      router.pathname === "/Signup/Customersignup" ||
      router.pathname === "/Signup/Vetsignup" ||
      router.pathname === "/Signup/adminsign"
    ) {
      setIsLoggedIn(false);
    } else {
      setIsLoggedIn(true);
    ...
    if (
      ...
      router.pathname === "/Vetchat" ||
      router.pathname === "/vetaccount" ||
      router.pathname === "/vet-dashboard" ||
      router.pathname === "/productup" ||
      router.pathname === "/accountdashboard"
    ) {
      setIsdashboard(true);
    } else {
                  ...
                  <ul className="navbar-nav pal-6">
                    <li className="nav-item dropdown pl-3">
                      ...
                      >
                        ...
                        <li>
                          <a
                            className=" m-2 texts-2"
                            onClick={() => {
                              router.push("/Signup/adminsign");
                            }}
                          >
                            Signup as Admin
                          </a>
